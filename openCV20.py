...
cv2.createTrackbar('Hue High','myTracker',20,180,onTrack2)

cv2.createTrackbar('Hue Low2','myTracker',1,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',0,180,onTrack8)

cv2.createTrackbar('Sat Low','myTracker',120,255,onTrack3)
...
while True:
    ...
    for contour in contours:
        ...
        if area>=200:
            ...
            Xpos=x
            Ypos=y
            Xpos=int(Xpos/width*960)
            Ypos=int(Ypos/height*540)
