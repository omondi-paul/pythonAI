...
cv2.createTrackbar('Hue Low2','myTracker',3,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',2,180,onTrack8)

cv2.createTrackbar('Sat Low','myTracker',60,255,onTrack3)
