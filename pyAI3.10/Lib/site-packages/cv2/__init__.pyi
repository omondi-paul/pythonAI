...
"""One of [VIDEOWRITER_PROP_QUALITY, VIDEOWRITER_PROP_FRAMEBYTES, VIDEOWRITER_PROP_NSTRIPES, VIDEOWRITER_PROP_IS_COLOR, VIDEOWRITER_PROP_DEPTH, VIDEOWRITER_PROP_HW_ACCELERATION, VIDEOWRITER_PROP_HW_DEVICE, VIDEOWRITER_PROP_HW_ACCELERATION_USE_OPENCL]"""
...
class KeyPoint:
    ...
    @staticmethod
    @typing.overload
    def convert(keypoints: typing.Sequence[KeyPoint], keypointIndexes: typing.Sequence[int] = ...) -> typing.Sequence[cv2.typing.Point2f]: ...
    @staticmethod
    @typing.overload
    def convert(points2f: typing.Sequence[cv2.typing.Point2f], size: float = ..., response: float = ..., octave: int = ..., class_id: int = ...) -> typing.Sequence[KeyPoint]: ...
...
class Subdiv2D:
    ...
    def getVoronoiFacetList(self, idx: typing.Sequence[int]) -> tuple[typing.Sequence[typing.Sequence[cv2.typing.Point2f]], typing.Sequence[cv2.typing.Point2f]]: ...
...
class Feature2D:
    ...
    @typing.overload
    def detect(self, images: typing.Sequence[cv2.typing.MatLike], masks: typing.Sequence[cv2.typing.MatLike] | None = ...) -> typing.Sequence[typing.Sequence[KeyPoint]]: ...
    @typing.overload
    def detect(self, images: typing.Sequence[UMat], masks: typing.Sequence[UMat] | None = ...) -> typing.Sequence[typing.Sequence[KeyPoint]]: ...

    @typing.overload
    def compute(self, image: cv2.typing.MatLike, keypoints: typing.Sequence[KeyPoint], descriptors: cv2.typing.MatLike | None = ...) -> tuple[typing.Sequence[KeyPoint], cv2.typing.MatLike]: ...
    @typing.overload
    def compute(self, image: UMat, keypoints: typing.Sequence[KeyPoint], descriptors: UMat | None = ...) -> tuple[typing.Sequence[KeyPoint], UMat]: ...
    @typing.overload
    def compute(self, images: typing.Sequence[cv2.typing.MatLike], keypoints: typing.Sequence[typing.Sequence[KeyPoint]], descriptors: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[typing.Sequence[typing.Sequence[KeyPoint]], typing.Sequence[cv2.typing.MatLike]]: ...
    @typing.overload
    def compute(self, images: typing.Sequence[UMat], keypoints: typing.Sequence[typing.Sequence[KeyPoint]], descriptors: typing.Sequence[UMat] | None = ...) -> tuple[typing.Sequence[typing.Sequence[KeyPoint]], typing.Sequence[UMat]]: ...

    @typing.overload
    def detectAndCompute(self, image: cv2.typing.MatLike, mask: cv2.typing.MatLike, descriptors: cv2.typing.MatLike | None = ..., useProvidedKeypoints: bool = ...) -> tuple[typing.Sequence[KeyPoint], cv2.typing.MatLike]: ...
    @typing.overload
    def detectAndCompute(self, image: UMat, mask: UMat, descriptors: UMat | None = ..., useProvidedKeypoints: bool = ...) -> tuple[typing.Sequence[KeyPoint], UMat]: ...
...
class BOWImgDescriptorExtractor:
    ...
    def compute(self, image: cv2.typing.MatLike, keypoints: typing.Sequence[KeyPoint], imgDescriptor: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
...
class VideoWriter:
    ...
    @typing.overload
    def __init__(self, filename: str, fourcc: int, fps: float, frameSize: cv2.typing.Size, params: typing.Sequence[int]) -> None: ...
    @typing.overload
    def __init__(self, filename: str, apiPreference: int, fourcc: int, fps: float, frameSize: cv2.typing.Size, params: typing.Sequence[int]) -> None: ...
    ...
    @typing.overload
    def open(self, filename: str, fourcc: int, fps: float, frameSize: cv2.typing.Size, params: typing.Sequence[int]) -> bool: ...
    @typing.overload
    def open(self, filename: str, apiPreference: int, fourcc: int, fps: float, frameSize: cv2.typing.Size, params: typing.Sequence[int]) -> bool: ...
...
class CascadeClassifier:
    ...
    @typing.overload
    def detectMultiScale(self, image: cv2.typing.MatLike, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ...) -> typing.Sequence[cv2.typing.Rect]: ...
    @typing.overload
    def detectMultiScale(self, image: UMat, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ...) -> typing.Sequence[cv2.typing.Rect]: ...

    @typing.overload
    def detectMultiScale2(self, image: cv2.typing.MatLike, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[int]]: ...
    @typing.overload
    def detectMultiScale2(self, image: UMat, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[int]]: ...

    @typing.overload
    def detectMultiScale3(self, image: cv2.typing.MatLike, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ..., outputRejectLevels: bool = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[int], typing.Sequence[float]]: ...
    @typing.overload
    def detectMultiScale3(self, image: UMat, scaleFactor: float = ..., minNeighbors: int = ..., flags: int = ..., minSize: cv2.typing.Size = ..., maxSize: cv2.typing.Size = ..., outputRejectLevels: bool = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[int], typing.Sequence[float]]: ...
...
class HOGDescriptor:
    ...
    @typing.overload
    def compute(self, img: cv2.typing.MatLike, winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., locations: typing.Sequence[cv2.typing.Point] = ...) -> typing.Sequence[float]: ...
    @typing.overload
    def compute(self, img: UMat, winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., locations: typing.Sequence[cv2.typing.Point] = ...) -> typing.Sequence[float]: ...

    @typing.overload
    def detect(self, img: cv2.typing.MatLike, hitThreshold: float = ..., winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., searchLocations: typing.Sequence[cv2.typing.Point] = ...) -> tuple[typing.Sequence[cv2.typing.Point], typing.Sequence[float]]: ...
    @typing.overload
    def detect(self, img: UMat, hitThreshold: float = ..., winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., searchLocations: typing.Sequence[cv2.typing.Point] = ...) -> tuple[typing.Sequence[cv2.typing.Point], typing.Sequence[float]]: ...

    @typing.overload
    def detectMultiScale(self, img: cv2.typing.MatLike, hitThreshold: float = ..., winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., scale: float = ..., groupThreshold: float = ..., useMeanshiftGrouping: bool = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[float]]: ...
    @typing.overload
    def detectMultiScale(self, img: UMat, hitThreshold: float = ..., winStride: cv2.typing.Size = ..., padding: cv2.typing.Size = ..., scale: float = ..., groupThreshold: float = ..., useMeanshiftGrouping: bool = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[float]]: ...
...
class QRCodeEncoder:
    ...
    @typing.overload
    def encodeStructuredAppend(self, encoded_info: str, qrcodes: typing.Sequence[cv2.typing.MatLike] | None = ...) -> typing.Sequence[cv2.typing.MatLike]: ...
    @typing.overload
    def encodeStructuredAppend(self, encoded_info: str, qrcodes: typing.Sequence[UMat] | None = ...) -> typing.Sequence[UMat]: ...
...
class GraphicalCodeDetector:
    ...
    @typing.overload
    def decodeMulti(self, img: cv2.typing.MatLike, points: cv2.typing.MatLike, straight_code: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[bool, typing.Sequence[str], typing.Sequence[cv2.typing.MatLike]]: ...
    @typing.overload
    def decodeMulti(self, img: UMat, points: UMat, straight_code: typing.Sequence[UMat] | None = ...) -> tuple[bool, typing.Sequence[str], typing.Sequence[UMat]]: ...

    @typing.overload
    def detectAndDecodeMulti(self, img: cv2.typing.MatLike, points: cv2.typing.MatLike | None = ..., straight_code: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[bool, typing.Sequence[str], cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike]]: ...
    @typing.overload
    def detectAndDecodeMulti(self, img: UMat, points: UMat | None = ..., straight_code: typing.Sequence[UMat] | None = ...) -> tuple[bool, typing.Sequence[str], UMat, typing.Sequence[UMat]]: ...
...
class GComputation:
    ...
    def apply(self, callback: cv2.typing.ExtractArgsCallback, args: typing.Sequence[GCompileArg] = ...) -> typing.Sequence[cv2.typing.GRunArg]: ...

    @typing.overload
    def compileStreaming(self, in_metas: typing.Sequence[cv2.typing.GMetaArg], args: typing.Sequence[GCompileArg] = ...) -> GStreamingCompiled: ...
    @typing.overload
    def compileStreaming(self, args: typing.Sequence[GCompileArg] = ...) -> GStreamingCompiled: ...
    @typing.overload
    def compileStreaming(self, callback: cv2.typing.ExtractMetaCallback, args: typing.Sequence[GCompileArg] = ...) -> GStreamingCompiled: ...
...
class Stitcher:
    ...
    @typing.overload
    def estimateTransform(self, images: typing.Sequence[cv2.typing.MatLike], masks: typing.Sequence[cv2.typing.MatLike] | None = ...) -> Stitcher_Status: ...
    @typing.overload
    def estimateTransform(self, images: typing.Sequence[UMat], masks: typing.Sequence[UMat] | None = ...) -> Stitcher_Status: ...
    ...
    @typing.overload
    def composePanorama(self, images: typing.Sequence[cv2.typing.MatLike], pano: cv2.typing.MatLike | None = ...) -> tuple[Stitcher_Status, cv2.typing.MatLike]: ...
    @typing.overload
    def composePanorama(self, images: typing.Sequence[UMat], pano: UMat | None = ...) -> tuple[Stitcher_Status, UMat]: ...

    @typing.overload
    def stitch(self, images: typing.Sequence[cv2.typing.MatLike], pano: cv2.typing.MatLike | None = ...) -> tuple[Stitcher_Status, cv2.typing.MatLike]: ...
    @typing.overload
    def stitch(self, images: typing.Sequence[UMat], pano: UMat | None = ...) -> tuple[Stitcher_Status, UMat]: ...
    @typing.overload
    def stitch(self, images: typing.Sequence[cv2.typing.MatLike], masks: typing.Sequence[cv2.typing.MatLike], pano: cv2.typing.MatLike | None = ...) -> tuple[Stitcher_Status, cv2.typing.MatLike]: ...
    @typing.overload
    def stitch(self, images: typing.Sequence[UMat], masks: typing.Sequence[UMat], pano: UMat | None = ...) -> tuple[Stitcher_Status, UMat]: ...
...
class AlignExposures(Algorithm):
    # Functions
    @typing.overload
    def process(self, src: typing.Sequence[cv2.typing.MatLike], dst: typing.Sequence[cv2.typing.MatLike], times: cv2.typing.MatLike, response: cv2.typing.MatLike) -> None: ...
    @typing.overload
    def process(self, src: typing.Sequence[UMat], dst: typing.Sequence[cv2.typing.MatLike], times: UMat, response: UMat) -> None: ...


class CalibrateCRF(Algorithm):
    # Functions
    @typing.overload
    def process(self, src: typing.Sequence[cv2.typing.MatLike], times: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
    @typing.overload
...
class MergeExposures(Algorithm):
    # Functions
    @typing.overload
    def process(self, src: typing.Sequence[cv2.typing.MatLike], times: cv2.typing.MatLike, response: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
    @typing.overload
...
class BRISK(Feature2D):
    ...
    @classmethod
    @typing.overload
    def create(cls, radiusList: typing.Sequence[float], numberList: typing.Sequence[int], dMax: float = ..., dMin: float = ..., indexChange: typing.Sequence[int] = ...) -> BRISK: ...
    @classmethod
    @typing.overload
    def create(cls, thresh: int, octaves: int, radiusList: typing.Sequence[float], numberList: typing.Sequence[int], dMax: float = ..., dMin: float = ..., indexChange: typing.Sequence[int] = ...) -> BRISK: ...
...
class MSER(Feature2D):
    ...
    @typing.overload
    def detectRegions(self, image: cv2.typing.MatLike) -> tuple[typing.Sequence[typing.Sequence[cv2.typing.Point]], typing.Sequence[cv2.typing.Rect]]: ...
    @typing.overload
    def detectRegions(self, image: UMat) -> tuple[typing.Sequence[typing.Sequence[cv2.typing.Point]], typing.Sequence[cv2.typing.Rect]]: ...
...
class AKAZE(Feature2D):
    # Functions
    @classmethod
    def create(cls, descriptor_type: AKAZE_DescriptorType = ..., descriptor_size: int = ..., descriptor_channels: int = ..., threshold: float = ..., nOctaves: int = ..., nOctaveLayers: int = ..., diffusivity: KAZE_DiffusivityType = ...) -> AKAZE: ...
...
class DescriptorMatcher(Algorithm):
    ...
    @typing.overload
    def match(self, queryDescriptors: cv2.typing.MatLike, trainDescriptors: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...) -> typing.Sequence[DMatch]: ...
    @typing.overload
    def match(self, queryDescriptors: UMat, trainDescriptors: UMat, mask: UMat | None = ...) -> typing.Sequence[DMatch]: ...
    @typing.overload
    def match(self, queryDescriptors: cv2.typing.MatLike, masks: typing.Sequence[cv2.typing.MatLike] | None = ...) -> typing.Sequence[DMatch]: ...
    @typing.overload
    def match(self, queryDescriptors: UMat, masks: typing.Sequence[UMat] | None = ...) -> typing.Sequence[DMatch]: ...

    @typing.overload
    def knnMatch(self, queryDescriptors: cv2.typing.MatLike, trainDescriptors: cv2.typing.MatLike, k: int, mask: cv2.typing.MatLike | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def knnMatch(self, queryDescriptors: UMat, trainDescriptors: UMat, k: int, mask: UMat | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def knnMatch(self, queryDescriptors: cv2.typing.MatLike, k: int, masks: typing.Sequence[cv2.typing.MatLike] | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def knnMatch(self, queryDescriptors: UMat, k: int, masks: typing.Sequence[UMat] | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...

    @typing.overload
    def radiusMatch(self, queryDescriptors: cv2.typing.MatLike, trainDescriptors: cv2.typing.MatLike, maxDistance: float, mask: cv2.typing.MatLike | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def radiusMatch(self, queryDescriptors: UMat, trainDescriptors: UMat, maxDistance: float, mask: UMat | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def radiusMatch(self, queryDescriptors: cv2.typing.MatLike, maxDistance: float, masks: typing.Sequence[cv2.typing.MatLike] | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
    @typing.overload
    def radiusMatch(self, queryDescriptors: UMat, maxDistance: float, masks: typing.Sequence[UMat] | None = ..., compactResult: bool = ...) -> typing.Sequence[typing.Sequence[DMatch]]: ...
...
class ShapeTransformer(Algorithm):
    # Functions
    @typing.overload
    def estimateTransformation(self, transformingShape: cv2.typing.MatLike, targetShape: cv2.typing.MatLike, matches: typing.Sequence[DMatch]) -> None: ...
    @typing.overload
    def estimateTransformation(self, transformingShape: UMat, targetShape: UMat, matches: typing.Sequence[DMatch]) -> None: ...
...
class MergeMertens(MergeExposures):
    ...
    def process(self, src: typing.Sequence[UMat], times: UMat, response: UMat, dst: UMat | None = ...) -> UMat: ...
    @typing.overload
    def process(self, src: typing.Sequence[cv2.typing.MatLike], dst: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
    @typing.overload
...
@typing.overload
def buildOpticalFlowPyramid(img: cv2.typing.MatLike, winSize: cv2.typing.Size, maxLevel: int, pyramid: typing.Sequence[cv2.typing.MatLike] | None = ..., withDerivatives: bool = ..., pyrBorder: int = ..., derivBorder: int = ..., tryReuseInputImage: bool = ...) -> tuple[int, typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def buildOpticalFlowPyramid(img: UMat, winSize: cv2.typing.Size, maxLevel: int, pyramid: typing.Sequence[UMat] | None = ..., withDerivatives: bool = ..., pyrBorder: int = ..., derivBorder: int = ..., tryReuseInputImage: bool = ...) -> tuple[int, typing.Sequence[UMat]]: ...

@typing.overload
def calcBackProject(images: typing.Sequence[cv2.typing.MatLike], channels: typing.Sequence[int], hist: cv2.typing.MatLike, ranges: typing.Sequence[float], scale: float, dst: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
@typing.overload
def calcBackProject(images: typing.Sequence[UMat], channels: typing.Sequence[int], hist: UMat, ranges: typing.Sequence[float], scale: float, dst: UMat | None = ...) -> UMat: ...
...
@typing.overload
def calibrateCamera(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], imageSize: cv2.typing.Size, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def calibrateCamera(objectPoints: typing.Sequence[UMat], imagePoints: typing.Sequence[UMat], imageSize: cv2.typing.Size, cameraMatrix: UMat, distCoeffs: UMat, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, UMat, UMat, typing.Sequence[UMat], typing.Sequence[UMat]]: ...

@typing.overload
def calibrateCameraExtended(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], imageSize: cv2.typing.Size, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., stdDeviationsIntrinsics: cv2.typing.MatLike | None = ..., stdDeviationsExtrinsics: cv2.typing.MatLike | None = ..., perViewErrors: cv2.typing.MatLike | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
@typing.overload
def calibrateCameraExtended(objectPoints: typing.Sequence[UMat], imagePoints: typing.Sequence[UMat], imageSize: cv2.typing.Size, cameraMatrix: UMat, distCoeffs: UMat, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ..., stdDeviationsIntrinsics: UMat | None = ..., stdDeviationsExtrinsics: UMat | None = ..., perViewErrors: UMat | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, UMat, UMat, typing.Sequence[UMat], typing.Sequence[UMat], UMat, UMat, UMat]: ...

@typing.overload
def calibrateCameraRO(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], imageSize: cv2.typing.Size, iFixedPoint: int, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., newObjPoints: cv2.typing.MatLike | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike]: ...
@typing.overload
def calibrateCameraRO(objectPoints: typing.Sequence[UMat], imagePoints: typing.Sequence[UMat], imageSize: cv2.typing.Size, iFixedPoint: int, cameraMatrix: UMat, distCoeffs: UMat, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ..., newObjPoints: UMat | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, UMat, UMat, typing.Sequence[UMat], typing.Sequence[UMat], UMat]: ...

@typing.overload
def calibrateCameraROExtended(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], imageSize: cv2.typing.Size, iFixedPoint: int, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., newObjPoints: cv2.typing.MatLike | None = ..., stdDeviationsIntrinsics: cv2.typing.MatLike | None = ..., stdDeviationsExtrinsics: cv2.typing.MatLike | None = ..., stdDeviationsObjPoints: cv2.typing.MatLike | None = ..., perViewErrors: cv2.typing.MatLike | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
@typing.overload
def calibrateCameraROExtended(objectPoints: typing.Sequence[UMat], imagePoints: typing.Sequence[UMat], imageSize: cv2.typing.Size, iFixedPoint: int, cameraMatrix: UMat, distCoeffs: UMat, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ..., newObjPoints: UMat | None = ..., stdDeviationsIntrinsics: UMat | None = ..., stdDeviationsExtrinsics: UMat | None = ..., stdDeviationsObjPoints: UMat | None = ..., perViewErrors: UMat | None = ..., flags: int = ..., criteria: cv2.typing.TermCriteria = ...) -> tuple[float, UMat, UMat, typing.Sequence[UMat], typing.Sequence[UMat], UMat, UMat, UMat, UMat, UMat]: ...

@typing.overload
def calibrateHandEye(R_gripper2base: typing.Sequence[cv2.typing.MatLike], t_gripper2base: typing.Sequence[cv2.typing.MatLike], R_target2cam: typing.Sequence[cv2.typing.MatLike], t_target2cam: typing.Sequence[cv2.typing.MatLike], R_cam2gripper: cv2.typing.MatLike | None = ..., t_cam2gripper: cv2.typing.MatLike | None = ..., method: HandEyeCalibrationMethod = ...) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike]: ...
@typing.overload
def calibrateHandEye(R_gripper2base: typing.Sequence[UMat], t_gripper2base: typing.Sequence[UMat], R_target2cam: typing.Sequence[UMat], t_target2cam: typing.Sequence[UMat], R_cam2gripper: UMat | None = ..., t_cam2gripper: UMat | None = ..., method: HandEyeCalibrationMethod = ...) -> tuple[UMat, UMat]: ...

@typing.overload
def calibrateRobotWorldHandEye(R_world2cam: typing.Sequence[cv2.typing.MatLike], t_world2cam: typing.Sequence[cv2.typing.MatLike], R_base2gripper: typing.Sequence[cv2.typing.MatLike], t_base2gripper: typing.Sequence[cv2.typing.MatLike], R_base2world: cv2.typing.MatLike | None = ..., t_base2world: cv2.typing.MatLike | None = ..., R_gripper2cam: cv2.typing.MatLike | None = ..., t_gripper2cam: cv2.typing.MatLike | None = ..., method: RobotWorldHandEyeCalibrationMethod = ...) -> tuple[cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike]: ...
@typing.overload
def calibrateRobotWorldHandEye(R_world2cam: typing.Sequence[UMat], t_world2cam: typing.Sequence[UMat], R_base2gripper: typing.Sequence[UMat], t_base2gripper: typing.Sequence[UMat], R_base2world: UMat | None = ..., t_base2world: UMat | None = ..., R_gripper2cam: UMat | None = ..., t_gripper2cam: UMat | None = ..., method: RobotWorldHandEyeCalibrationMethod = ...) -> tuple[UMat, UMat, UMat, UMat]: ...
...
@typing.overload
def decomposeHomographyMat(H: cv2.typing.MatLike, K: cv2.typing.MatLike, rotations: typing.Sequence[cv2.typing.MatLike] | None = ..., translations: typing.Sequence[cv2.typing.MatLike] | None = ..., normals: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[int, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def decomposeHomographyMat(H: UMat, K: UMat, rotations: typing.Sequence[UMat] | None = ..., translations: typing.Sequence[UMat] | None = ..., normals: typing.Sequence[UMat] | None = ...) -> tuple[int, typing.Sequence[UMat], typing.Sequence[UMat], typing.Sequence[UMat]]: ...
...
def denoise_TVL1(observations: typing.Sequence[cv2.typing.MatLike], result: cv2.typing.MatLike, lambda_: float = ..., niters: int = ...) -> None: ...
...
@typing.overload
def drawContours(image: cv2.typing.MatLike, contours: typing.Sequence[cv2.typing.MatLike], contourIdx: int, color: cv2.typing.Scalar, thickness: int = ..., lineType: int = ..., hierarchy: cv2.typing.MatLike | None = ..., maxLevel: int = ..., offset: cv2.typing.Point = ...) -> cv2.typing.MatLike: ...
@typing.overload
def drawContours(image: UMat, contours: typing.Sequence[UMat], contourIdx: int, color: cv2.typing.Scalar, thickness: int = ..., lineType: int = ..., hierarchy: UMat | None = ..., maxLevel: int = ..., offset: cv2.typing.Point = ...) -> UMat: ...
...
@typing.overload
def drawKeypoints(image: cv2.typing.MatLike, keypoints: typing.Sequence[KeyPoint], outImage: cv2.typing.MatLike, color: cv2.typing.Scalar = ..., flags: DrawMatchesFlags = ...) -> cv2.typing.MatLike: ...
@typing.overload
def drawKeypoints(image: UMat, keypoints: typing.Sequence[KeyPoint], outImage: UMat, color: cv2.typing.Scalar = ..., flags: DrawMatchesFlags = ...) -> UMat: ...
...
@typing.overload
def drawMatches(img1: cv2.typing.MatLike, keypoints1: typing.Sequence[KeyPoint], img2: cv2.typing.MatLike, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[DMatch], outImg: cv2.typing.MatLike, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[str] = ..., flags: DrawMatchesFlags = ...) -> cv2.typing.MatLike: ...
@typing.overload
def drawMatches(img1: UMat, keypoints1: typing.Sequence[KeyPoint], img2: UMat, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[DMatch], outImg: UMat, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[str] = ..., flags: DrawMatchesFlags = ...) -> UMat: ...
@typing.overload
def drawMatches(img1: cv2.typing.MatLike, keypoints1: typing.Sequence[KeyPoint], img2: cv2.typing.MatLike, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[DMatch], outImg: cv2.typing.MatLike, matchesThickness: int, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[str] = ..., flags: DrawMatchesFlags = ...) -> cv2.typing.MatLike: ...
@typing.overload
def drawMatches(img1: UMat, keypoints1: typing.Sequence[KeyPoint], img2: UMat, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[DMatch], outImg: UMat, matchesThickness: int, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[str] = ..., flags: DrawMatchesFlags = ...) -> UMat: ...

@typing.overload
def drawMatchesKnn(img1: cv2.typing.MatLike, keypoints1: typing.Sequence[KeyPoint], img2: cv2.typing.MatLike, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[typing.Sequence[DMatch]], outImg: cv2.typing.MatLike, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[typing.Sequence[str]] = ..., flags: DrawMatchesFlags = ...) -> cv2.typing.MatLike: ...
@typing.overload
def drawMatchesKnn(img1: UMat, keypoints1: typing.Sequence[KeyPoint], img2: UMat, keypoints2: typing.Sequence[KeyPoint], matches1to2: typing.Sequence[typing.Sequence[DMatch]], outImg: UMat, matchColor: cv2.typing.Scalar = ..., singlePointColor: cv2.typing.Scalar = ..., matchesMask: typing.Sequence[typing.Sequence[str]] = ..., flags: DrawMatchesFlags = ...) -> UMat: ...
...
def ellipse2Poly(center: cv2.typing.Point, axes: cv2.typing.Size, angle: int, arcStart: int, arcEnd: int, delta: int) -> typing.Sequence[cv2.typing.Point]: ...
...
@typing.overload
def fastNlMeansDenoising(src: cv2.typing.MatLike, h: typing.Sequence[float], dst: cv2.typing.MatLike | None = ..., templateWindowSize: int = ..., searchWindowSize: int = ..., normType: int = ...) -> cv2.typing.MatLike: ...
@typing.overload
def fastNlMeansDenoising(src: UMat, h: typing.Sequence[float], dst: UMat | None = ..., templateWindowSize: int = ..., searchWindowSize: int = ..., normType: int = ...) -> UMat: ...
...
@typing.overload
def fastNlMeansDenoisingColoredMulti(srcImgs: typing.Sequence[cv2.typing.MatLike], imgToDenoiseIndex: int, temporalWindowSize: int, dst: cv2.typing.MatLike | None = ..., h: float = ..., hColor: float = ..., templateWindowSize: int = ..., searchWindowSize: int = ...) -> cv2.typing.MatLike: ...
@typing.overload
def fastNlMeansDenoisingColoredMulti(srcImgs: typing.Sequence[UMat], imgToDenoiseIndex: int, temporalWindowSize: int, dst: UMat | None = ..., h: float = ..., hColor: float = ..., templateWindowSize: int = ..., searchWindowSize: int = ...) -> UMat: ...

@typing.overload
def fastNlMeansDenoisingMulti(srcImgs: typing.Sequence[cv2.typing.MatLike], imgToDenoiseIndex: int, temporalWindowSize: int, dst: cv2.typing.MatLike | None = ..., h: float = ..., templateWindowSize: int = ..., searchWindowSize: int = ...) -> cv2.typing.MatLike: ...
@typing.overload
def fastNlMeansDenoisingMulti(srcImgs: typing.Sequence[UMat], imgToDenoiseIndex: int, temporalWindowSize: int, dst: UMat | None = ..., h: float = ..., templateWindowSize: int = ..., searchWindowSize: int = ...) -> UMat: ...
@typing.overload
def fastNlMeansDenoisingMulti(srcImgs: typing.Sequence[cv2.typing.MatLike], imgToDenoiseIndex: int, temporalWindowSize: int, h: typing.Sequence[float], dst: cv2.typing.MatLike | None = ..., templateWindowSize: int = ..., searchWindowSize: int = ..., normType: int = ...) -> cv2.typing.MatLike: ...
@typing.overload
def fastNlMeansDenoisingMulti(srcImgs: typing.Sequence[UMat], imgToDenoiseIndex: int, temporalWindowSize: int, h: typing.Sequence[float], dst: UMat | None = ..., templateWindowSize: int = ..., searchWindowSize: int = ..., normType: int = ...) -> UMat: ...
...
@typing.overload
def fillPoly(img: cv2.typing.MatLike, pts: typing.Sequence[cv2.typing.MatLike], color: cv2.typing.Scalar, lineType: int = ..., shift: int = ..., offset: cv2.typing.Point = ...) -> cv2.typing.MatLike: ...
@typing.overload
def fillPoly(img: UMat, pts: typing.Sequence[UMat], color: cv2.typing.Scalar, lineType: int = ..., shift: int = ..., offset: cv2.typing.Point = ...) -> UMat: ...
...
@typing.overload
def filterHomographyDecompByVisibleRefpoints(rotations: typing.Sequence[cv2.typing.MatLike], normals: typing.Sequence[cv2.typing.MatLike], beforePoints: cv2.typing.MatLike, afterPoints: cv2.typing.MatLike, possibleSolutions: cv2.typing.MatLike | None = ..., pointsMask: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
@typing.overload
def filterHomographyDecompByVisibleRefpoints(rotations: typing.Sequence[UMat], normals: typing.Sequence[UMat], beforePoints: UMat, afterPoints: UMat, possibleSolutions: UMat | None = ..., pointsMask: UMat | None = ...) -> UMat: ...
...
@typing.overload
def findContours(image: cv2.typing.MatLike, mode: int, method: int, contours: typing.Sequence[cv2.typing.MatLike] | None = ..., hierarchy: cv2.typing.MatLike | None = ..., offset: cv2.typing.Point = ...) -> tuple[typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike]: ...
@typing.overload
...
def groupRectangles(rectList: typing.Sequence[cv2.typing.Rect], groupThreshold: int, eps: float = ...) -> tuple[typing.Sequence[cv2.typing.Rect], typing.Sequence[int]]: ...
...
@typing.overload
def imdecodemulti(buf: cv2.typing.MatLike, flags: int, mats: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[bool, typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def imdecodemulti(buf: UMat, flags: int, mats: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[bool, typing.Sequence[cv2.typing.MatLike]]: ...

@typing.overload
def imencode(ext: str, img: cv2.typing.MatLike, params: typing.Sequence[int] = ...) -> tuple[bool, numpy.ndarray[typing.Any, numpy.dtype[numpy.uint8]]]: ...
@typing.overload
def imencode(ext: str, img: UMat, params: typing.Sequence[int] = ...) -> tuple[bool, numpy.ndarray[typing.Any, numpy.dtype[numpy.uint8]]]: ...

def imread(filename: str, flags: int = ...) -> cv2.typing.MatLike: ...

@typing.overload
def imreadmulti(filename: str, mats: typing.Sequence[cv2.typing.MatLike] | None = ..., flags: int = ...) -> tuple[bool, typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def imreadmulti(filename: str, start: int, count: int, mats: typing.Sequence[cv2.typing.MatLike] | None = ..., flags: int = ...) -> tuple[bool, typing.Sequence[cv2.typing.MatLike]]: ...
...
@typing.overload
def imwritemulti(filename: str, img: typing.Sequence[cv2.typing.MatLike], params: typing.Sequence[int] = ...) -> bool: ...
@typing.overload
...
@typing.overload
def initCameraMatrix2D(objectPoints: typing.Sequence[cv2.typing.MatLike], imagePoints: typing.Sequence[cv2.typing.MatLike], imageSize: cv2.typing.Size, aspectRatio: float = ...) -> cv2.typing.MatLike: ...
@typing.overload
def initCameraMatrix2D(objectPoints: typing.Sequence[UMat], imagePoints: typing.Sequence[UMat], imageSize: cv2.typing.Size, aspectRatio: float = ...) -> cv2.typing.MatLike: ...
...
@typing.overload
def mixChannels(src: typing.Sequence[cv2.typing.MatLike], dst: typing.Sequence[cv2.typing.MatLike], fromTo: typing.Sequence[int]) -> typing.Sequence[cv2.typing.MatLike]: ...
@typing.overload
def mixChannels(src: typing.Sequence[UMat], dst: typing.Sequence[UMat], fromTo: typing.Sequence[int]) -> typing.Sequence[UMat]: ...
...
@typing.overload
def polylines(img: cv2.typing.MatLike, pts: typing.Sequence[cv2.typing.MatLike], isClosed: bool, color: cv2.typing.Scalar, thickness: int = ..., lineType: int = ..., shift: int = ...) -> cv2.typing.MatLike: ...
@typing.overload
def polylines(img: UMat, pts: typing.Sequence[UMat], isClosed: bool, color: cv2.typing.Scalar, thickness: int = ..., lineType: int = ..., shift: int = ...) -> UMat: ...
...
@typing.overload
def rectify3Collinear(cameraMatrix1: UMat, distCoeffs1: UMat, cameraMatrix2: UMat, distCoeffs2: UMat, cameraMatrix3: UMat, distCoeffs3: UMat, imgpt1: typing.Sequence[UMat], imgpt3: typing.Sequence[UMat], imageSize: cv2.typing.Size, R12: UMat, T12: UMat, R13: UMat, T13: UMat, alpha: float, newImgSize: cv2.typing.Size, flags: int, R1: UMat | None = ..., R2: UMat | None = ..., R3: UMat | None = ..., P1: UMat | None = ..., P2: UMat | None = ..., P3: UMat | None = ..., Q: UMat | None = ...) -> tuple[float, UMat, UMat, UMat, UMat, UMat, UMat, UMat, cv2.typing.Rect, cv2.typing.Rect]: ...
...
@typing.overload
def selectROIs(windowName: str, img: cv2.typing.MatLike, showCrosshair: bool = ..., fromCenter: bool = ..., printNotice: bool = ...) -> typing.Sequence[cv2.typing.Rect]: ...
@typing.overload
def selectROIs(windowName: str, img: UMat, showCrosshair: bool = ..., fromCenter: bool = ..., printNotice: bool = ...) -> typing.Sequence[cv2.typing.Rect]: ...
...
@typing.overload
def solveP3P(objectPoints: cv2.typing.MatLike, imagePoints: cv2.typing.MatLike, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, flags: int, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ...) -> tuple[int, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike]]: ...
@typing.overload
def solveP3P(objectPoints: UMat, imagePoints: UMat, cameraMatrix: UMat, distCoeffs: UMat, flags: int, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ...) -> tuple[int, typing.Sequence[UMat], typing.Sequence[UMat]]: ...
...
@typing.overload
def solvePnPGeneric(objectPoints: cv2.typing.MatLike, imagePoints: cv2.typing.MatLike, cameraMatrix: cv2.typing.MatLike, distCoeffs: cv2.typing.MatLike, rvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., tvecs: typing.Sequence[cv2.typing.MatLike] | None = ..., useExtrinsicGuess: bool = ..., flags: SolvePnPMethod = ..., rvec: cv2.typing.MatLike | None = ..., tvec: cv2.typing.MatLike | None = ..., reprojectionError: cv2.typing.MatLike | None = ...) -> tuple[int, typing.Sequence[cv2.typing.MatLike], typing.Sequence[cv2.typing.MatLike], cv2.typing.MatLike]: ...
@typing.overload
def solvePnPGeneric(objectPoints: UMat, imagePoints: UMat, cameraMatrix: UMat, distCoeffs: UMat, rvecs: typing.Sequence[UMat] | None = ..., tvecs: typing.Sequence[UMat] | None = ..., useExtrinsicGuess: bool = ..., flags: SolvePnPMethod = ..., rvec: UMat | None = ..., tvec: UMat | None = ..., reprojectionError: UMat | None = ...) -> tuple[int, typing.Sequence[UMat], typing.Sequence[UMat], UMat]: ...
...
@typing.overload
def split(m: cv2.typing.MatLike, mv: typing.Sequence[cv2.typing.MatLike] | None = ...) -> typing.Sequence[cv2.typing.MatLike]: ...
@typing.overload
...
@typing.overload
def transposeND(src: cv2.typing.MatLike, order: typing.Sequence[int], dst: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
@typing.overload
